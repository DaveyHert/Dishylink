      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative flex h-11 flex-none cursor-pointer items-center gap-3.5 rounded-full border-0 bg-transparent px-[11px] text-[var(--ink-secondary)] transition-colors hover:bg-[color-mix(in_srgb,var(--ink)_6%,transparent)] hover:text-foreground",
