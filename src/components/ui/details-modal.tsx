          ...
          >
            <div className='mb-1.5 flex items-center gap-2'>
              ...
              <DialogPrimitive.Close
                aria-label='Close'
                className='ml-auto inline-flex h-[30px] w-[30px] cursor-pointer items-center justify-center rounded-[999px] border-0 bg-[color-mix(in_srgb,var(--ink)_6%,var(--surface))] text-[13px] text-[var(--ink-secondary)] hover:text-[var(--ink)]'
              >
                ✕
              </DialogPrimitive.Close>
            </div>
